...
const Apartments = () => {
  ...
  return (
    <div className='flex flex-col gap-16 justify-center pt-36 px-36'>
        <h1 className='border-b-[#23272f] border-b-[1px] pb-4 italic text-4xl font-normal text-[#f6f7f9] text-left'>Apartments</h1>
          ...
          <tbody>
            {apartments.map(apartment =>
              <tr key={apartment.id} className='border-b-[#23272f] border-b-[1px]'>
                ...
                <td className='py-2 px-6'><img width='30' height='30' src='https://www.phillyaptrentals.com/wp-content/uploads/2020/12/apartment-building-what-makes-good-apartment-building-scaled.jpg' /></td>
