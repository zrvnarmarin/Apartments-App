...
const ApartmentTableHeader = () => {
  return (
    <>
        ...
        <div className='flex items-center justify-center border-b-[#23272f] border-b-[1px] px-0 py-1 text-sm md:text-md lg:text-lg xl:text-xl  whitespace-normal'>Image</div>
